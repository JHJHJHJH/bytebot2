...
<Cards>
  ...
  <Card title="Security & Development">
...
<Cards>
  ...
  <Card title="API Reference" href="/api-reference/computer-use/unified-endpoint">
    Control the desktop programmatically
  </Card>
  <Card title="Agent System" href="/core-concepts/agent-system">
    Add AI capabilities
  </Card>
  <Card title="Password Management" href="/guides/password-management">
