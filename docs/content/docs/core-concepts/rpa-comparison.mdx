...
<Tabs items={["Traditional RPA","Bytebot"]}>
  <Tab value="Traditional RPA">
    ```csharp
...
<Cards>
  ...
  <Card title="GitHub" href="https://github.com/bytebot-ai/bytebot">
    View source code and contribute
  </Card>
  <Card title="Community" href="https://discord.gg/zcb5wA2t4u">
    Join our Discord for support
  </Card>
  <Card title="Enterprise Support" href="https://discord.gg/zcb5wA2t4u">
