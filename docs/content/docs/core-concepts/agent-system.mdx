...
<Accordions type="multiple">
  <Accordion title="Agent not responding">
    - Open `/models` and check your AI provider API key is configured and valid
...
<Cards>
  ...
  <Card title="API Reference" href="/api-reference/agent/tasks">
    Integrate with your apps
  </Card>
  <Card title="Use Cases" href="#example-use-cases">
    See what's possible
  </Card>
